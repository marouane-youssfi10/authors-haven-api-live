...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("phone number"), max_length=30, default="+212*********")
    ...
    city = models.CharField(verbose_name=_("city"), max_length=180, default="Meknes", blank=False, null=False)
